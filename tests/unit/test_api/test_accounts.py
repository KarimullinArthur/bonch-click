...
async def client():
    ...
    app.dependency_overrides[verify_token] = _verify_token
...
async def test_get_account(client, mock_session):
    mock_account = Account(email="test@test.com", password="password")
...
@pytest.mark.asyncio
async def test_get_nonexitent_account(client, mock_session):
